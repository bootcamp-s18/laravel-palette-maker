...
<!-- 
 ...
 -->
	<div>
		<form class="form-inline mt-5" method="post" action="/color/create">
			<label class="sr-only" for="colorName">Color Name</label>
			<input type="text" class="rounded-0 form-control mb-2 mr-sm-2 mb-sm-0" id="colorName" name="colorName" placeholder="The deep dark void..." required>
			<label class="sr-only" for="hexCode">Hex Code</label>
			<div class="input-group mb-2 mr-sm-2 mb-sm-0">
				<div class="input-group-prepend">
					<div class="rounded-0 input-group-text">#</div>
				</div>
				<input type="text" class="rounded-0form-control" id="hexCode" name="hexCode" placeholder="a1b2c3" maxlength="6" size="6" required>
			</div>
	...
	<div>
		<form class="form-inline mt-3" method="post" action="/palette/create">
			<label class="sr-only" for="paletteName">Palette Name</label>
			<input type="text" class="rounded-0 form-control mb-2 mr-sm-2 mb-sm-0" id="paletteName" name="paletteName" placeholder="The most beautiful..." required>
			...
			<div class="card rounded-0">
				...
				<div id="collapse{{ $palette->id }}" class="collapse" data-parent="#palettes">
					...
					@endforeach
						...
						<div class="card rounded-0">
							<div class="card-header row" id="newColors{{ $palette->id }}" style="margin: 0 !important; padding: 0 !important; background-color: #FFFFFF;">
							...
							<div class="col m-auto">
								<div class="dropright">
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
										...
										@foreach ($palette->unusedColors() as $color) 
				
										<a class="dropdown-item" href="/palette/{{ $palette->id }}/colors/{{ $color->id }}/add">{{ 	$color->name }}</a>
